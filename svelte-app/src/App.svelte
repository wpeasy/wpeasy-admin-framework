...
<div class="wpea wpea-full wpea-cq demo-shell" style="--wpea-density: {density}; font-size: {density === 'compact' ? 'calc(var(--wpea-fs-base) * 0.875)' : 'var(--wpea-fs-base)'}; font-family: var(--wpea-font-sans);">
  <!-- HEADER -->
